...
public class AuthorsAdapter extends RecyclerView.Adapter<AuthorsAdapter.MyAuthor> {
    List<Author> list = Collections.emptyList();
    Context mContext;
    public AuthorsAdapter(List<Author> list, Context context){
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyAuthor holder, int position) {
        ...
        holder.authorItemCard.setOnClickListener(view->{
            ...
            extras.putInt("author_id",author.getId());
